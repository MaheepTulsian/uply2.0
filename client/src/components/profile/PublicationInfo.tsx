...
const PublicationInfo: React.FC<PublicationInfoProps> = ({ formRef, onSuccess }) => {
        ...
        const fetchPublications = async () => {
            ...
            try {
                ...
                if (profileData.publications && profileData.publications.length > 0) {
                    ...
                    const formattedPublications = profileData.publications.map((pub: any) => ({
                        ...pub,
    ...
    const onSubmit: SubmitHandler<FormValues> = async (data) => {
        ...
        try {
            const response = await axios.post(`${API_BASE_URL}/${id}/publication_info`, {
